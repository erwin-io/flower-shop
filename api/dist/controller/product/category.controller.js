...
let CategoryController = class CategoryController {
    ...
    async getDetails(categoryId) {
        const res = {};
        try {
            res.data = await this.staffAccessService.getById(categoryId);
            res.success = true;
            return res;
        }
        catch (e) {
    ...
    async getPaginated(params) {
        const res = {};
        try {
            res.data = await this.staffAccessService.getCategoryPagination(params);
            res.success = true;
            return res;
        }
        catch (e) {
    ...
    async update(categoryId, dto) {
        const res = {};
        try {
            res.data = await this.staffAccessService.update(categoryId, dto);
            res.success = true;
    ...
    async delete(categoryId) {
        const res = {};
        try {
            res.data = await this.staffAccessService.delete(categoryId);
            res.success = true;
